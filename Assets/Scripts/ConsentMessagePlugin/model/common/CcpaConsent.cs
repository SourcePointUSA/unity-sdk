...
namespace ConsentManagementProviderLib
{
    public class CcpaConsent
    {
        ...
        public CcpaConsent(string status, string uspstring, List<string> rejectedVendors, List<string> rejectedCategories)
        {
            this.status = status;
        ...
        public CcpaConsent(string status, string uspstring, string[] rejectedVendors, string[] rejectedCategories)
        {
            this.status = status;
            this.uspstring = uspstring;
