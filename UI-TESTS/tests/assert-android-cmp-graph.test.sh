...
assert_fails_with core-version-prefix-7.15.13.txt 7.15.13 'com.sourcepoint:core:0.1.16'
...
assert_fails_with ktor-4-selected-7.15.13.txt 7.15.13 'io.ktor:ktor-client-core:3.2.2 -> 4.0.0'
